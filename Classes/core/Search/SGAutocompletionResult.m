...
+ (SGKImage *)imageForType:(SGAutocompletionSearchIcon)type
{
    ...
    case SGAutocompletionSearchIconCity:
      return [SGStyleManager imageNamed:@"icon-search-city"];
      
    case SGAutocompletionSearchIconContact:
      return [SGStyleManager imageNamed:@"icon-search-contact"];
      
    case SGAutocompletionSearchIconCurrentLocation:
      return [SGStyleManager imageNamed:@"icon-search-currentlocation"];
      
    case SGAutocompletionSearchIconPin:
      return [SGStyleManager imageNamed:@"icon-search-pin"];
      
    case SGAutocompletionSearchIconCalendar:
      return [SGStyleManager imageNamed:@"icon-search-calendar"];
      
    case SGAutocompletionSearchIconHistory:
      return [SGStyleManager imageNamed:@"icon-search-history"];
      
    case SGAutocompletionSearchIconFavourite:
      return [SGStyleManager imageNamed:@"icon-search-favourite"];
  }
}
