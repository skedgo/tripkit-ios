 ...
 */
+ (NSDictionary<NSString *, id> *)skedGoFullDictionaryForVehicle:(id<STKVehicular>)vehicle;
 ...
 */
+ (NSDictionary<NSString *, id> *)skedGoReferenceDictionaryForVehicle:(id<STKVehicular>)vehicle;
