...
//! Project version number for TripKitInterApp_iOS.
FOUNDATION_EXPORT double TripKitInterApp_iOSVersionNumber;

//! Project version string for TripKitInterApp_iOS.
