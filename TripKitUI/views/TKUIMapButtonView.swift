...
@available(*, unavailable, renamed: "TKUIMapButtonView")
public typealias TKMapButtonView = TKUIMapButtonView
...
class TKUIPassthroughStackView: UIStackView {
...
@objc public class TKUIMapButtonView: UIView {
  ...
  private func prepareWrapper() {
    let wrapper = TKUIPassthroughStackView()
