...
@interface SGPulsingAnnotationView ()
...
@implementation SGPulsingAnnotationView
...
- (UIImage*)haloImageWithRadius:(CGFloat)radius {
    ...
    UIImage *ringImage = [[SGPulsingAnnotationView cachedRingImages] objectForKey:key];
    ...
    if(!ringImage) {
        ...
        [[SGPulsingAnnotationView cachedRingImages] setObject:ringImage forKey:key];
