...
@available(*, unavailable, renamed: "TKUIDepartureView")
public typealias TKDepartureView = TKUIDepartureView

@available(*, unavailable, renamed: "TKUIDepartureViewDestination")
public typealias TKDepartureViewDestination = TKUIDepartureViewDestination
...
public class TKUIDepartureView: UIView {

  @IBOutlet weak var tripSegmentView: TKUITripSegmentsView!
  ...
  public static func makeView() -> TKUIDepartureView {
  ...
  public func configure(for trip: STKTrip, to destination: SGTrackItemDisplayable?) {
    ...
    let destinationInfo = TKUIDepartureViewDestination(
