...
public class Loc : NSObject {
  ...
  public static func TripAboutToStart() -> String {
    let format = NSLocalizedString("The trip is about to start", tableName: "TripKit", bundle: .tripKit, comment: "Notification title when trip is about to start.")
    return String(format: format)
  }
  
  public static func LeavingOn(location: String, time: String) -> String {
    let format = NSLocalizedString("Leaving %@ on %@", tableName: "TripKit", bundle: .tripKit, comment: "Notification message when trip is about to start.")
    return String(format: format, location, time)
  }
  
  // 2 Near Final
  
  public static func AlmostThere() -> String {
    let format = NSLocalizedString("Almost there", tableName: "TripKit", bundle: .tripKit, comment: "Notification title when current location is 500 meters away disembarkation point.")
    return String(format: format)
  }
  
  public static func GettingNearDisembarkationPoint() -> String {
    let format = NSLocalizedString("Getting within 500m of the disembarkation point", tableName: "TripKit", bundle: .tripKit, comment: "Notification mesage when current location is 500 meters away disembarkation point.")
    return String(format: format)
  }
  
  // 3 Just passed stop
  
  public static func Leaving(_ location: String) -> String {
    let format = NSLocalizedString("Leaving %@", tableName: "TripKit", bundle: .tripKit, comment: "Notification title when current location passed the circular region of the stop that was recently passed through within the trip.")
    return String(format: format, location)
  }
  
  public static func Next(_ location: String) -> String {
    let format = NSLocalizedString("Next: %@", tableName: "TripKit", bundle: .tripKit, comment: "Notification message when current location passed the circular region of the stop that was recently passed through within the trip.")
    return String(format: format, location)
  }
  
  // 4 Final
  
  public static func ArrivingAtYourStop() -> String {
    let format = NSLocalizedString("Arriving at your stop", tableName: "TripKit", bundle: .tripKit, comment: "Notification title when current location is near the final destination of the trip.")
    return String(format: format)
  }
  
  public static func PrepareToDisembarkAt(_ location: String) -> String {
    let format = NSLocalizedString("Prepare to disembark at %@", tableName: "TripKit", bundle: .tripKit, comment: "Notification message when current location is near the trip's last stop.")
    return String(format: format, location)
  }
