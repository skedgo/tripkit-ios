...
public class Loc : NSObject {
  ...
  public static var Alert: String {
    return NSLocalizedString("Alert", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Default title for alert view")
  }

  @objc
  public static var Back: String {
    return NSLocalizedString("Back", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Accessibility label for 'back' or 'previous' button")
  }
  
  @objc
  public static var Cancel: String {
    return NSLocalizedString("Cancel", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Cancel action")
  }
  ...
  public static var Close: String {
    return NSLocalizedString("Close", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Close action")
  }
  
  @objc
  public static var Later: String {
    return NSLocalizedString("Later", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Title of button to perform some action at a later time")
  }
  
  @objc
  public static var Confirm: String {
    return NSLocalizedString("Confirm", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Title on the button that asks users to confirm if they want to proceed with booking")
  }
  
  @objc
  public static var Delete: String {
    return NSLocalizedString("Delete", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Delete action")
  }
  
  @objc
  public static var Done: String {
    return NSLocalizedString("Done", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Done action")
  }
  ...
  public static var Retry: String {
    return NSLocalizedString("Retry", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Retry action, e.g., in case something didn't load")
  }
  
  @objc
  public static var Location: String {
    return NSLocalizedString("Location", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Title for unnamed location")
  }
  ...
  public static var ForWhenToLeave: String {
    return NSLocalizedString("For when to leave", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Reminder to leave preference")
  }
  
  @objc
  public static var MinutesBeforeTrip: String {
    return NSLocalizedString("Minutes before trip", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Reminder to leave preference")
  }
  
  @objc
  public static var Reminder: String {
    return NSLocalizedString("Reminder", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Action title to add/remove reminder")
  }
  ...
  public static var Never: String {
    return NSLocalizedString("Never", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Response to question whether user wants to report a problem when taking a screenshot. Also used in context of repetitions (especially recurring events).")
  }
  
  @objc
  public static var ReportProblem: String {
    return NSLocalizedString("Report Problem", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Button title to report a problem")
  }
  
  @objc
  public static var WouldYouLikeToReportAProblem: String {
    return NSLocalizedString("Would you like to report a problem?", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Question asked when user is taking a screenshot")
  }
  ...
  public static var CurrentLocation: String {
    return NSLocalizedString("Current Location", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Title for user's current location")
  }
  
  @objc
  public static var ChangeTrackingOptions: String {
    return NSLocalizedString("Change tracking options", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Accessibility - user location button - hint")
  }
  
  @objc
  public static var TrackingOff: String {
    return NSLocalizedString("Tracking - off", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Accessibility - user location button - off")
  }
  
  @objc
  public static var TrackingOn: String {
    return NSLocalizedString("Tracking - on", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "user location button - follow")
  }
  
  @objc
  public static var TrackingOnWithHeading: String {
    return NSLocalizedString("Tracking - on with heading", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "user location button - follow with heading")
  }
  
  @objc
  public static var TapToSetLocation: String {
    return NSLocalizedString("Tap to set location", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Tap to set location. (old key: SetLocation)")
  }
  
  @objc
  public static var PleaseVerifyTheLocation: String {
    return NSLocalizedString("Please verify the location", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Please verify the location prompt")
  }
  
  @objc
  public static var PleaseSelectALocation: String {
    return NSLocalizedString("Please select a location", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Please select a location prompt")
  }
  
  @objc
  public static var Search: String {
    return NSLocalizedString("Search", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Empty search bar placeholder")
  }
  
  @objc
  public static var Score: String {
    return NSLocalizedString("Score", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Sort by overall score, like a ranking.")
  }
  
  @objc
  public static var Distance: String {
    return NSLocalizedString("Distance", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Sort by distance")
  }
  
  @objc
  public static var SearchResults: String {
    return NSLocalizedString("Search Results", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "")
  }
  ...
  public static func Recurrences(_ count: Int) -> String {
    let format = NSLocalizedString("%lu recurrences", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Number of repeats. (old key: NumberRecurrences)")
    return String(format: format, count)
  }

  @objc(FromDate:)
  public static func From(date: String) -> String {
    let format = NSLocalizedString("Starting %@", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Starting %date. (old key: DateFromFormat)")
    return String(format: format, date)
  }
  
  @objc(ToDate:)
  public static func To(date: String) -> String {
    let format = NSLocalizedString("Up to %@", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Up to %date. (old key: DateToFormat)")
    return String(format: format, date)
  }
  
  public static func LastUpdated(date: String) -> String {
    let format = NSLocalizedString("Last updated: %@", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "Last updated at %date")
    return String.init(format: format, date)
  }
  
  @objc(Every:)
  public static func Every(dayString: String) -> String {
    let format = NSLocalizedString("Every %@", tableName: "Shared", bundle: TKStyleManager.bundle(), comment: "'Every %day' in context of repetitions (especially recurring events), e.g., 'Every Monday'. (old key: EveryDayFormat)")
